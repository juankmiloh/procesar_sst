            ...
            <nav class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active">
                            <a><i class="icon-graphic_eq"></i> <?= Yii::t("app", "ARTICULOS") ?></a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <div class="container-fluid">
                <div class="row gutter">
                    <div class="col-md-10 col-sm-6 col-xs-12">
                        <h3 class="page-title"><?= Yii::t('app', "ARTICULOS") ?></h3>
                    </div>
                    <div class="col-md-2 col-sm-6 col-xs-12">
                        <ul class="tasks pull-right clearfix">
                            <button type="button" class="btn teal-bg btn-block" onclick="cleanForm()" data-toggle="modal" data-target="#modalForm"><i class="icon-circle-plus icon-left"></i><?= Yii::t('app', "CREAR_ARTICULO") ?></button>
                        </ul>
                    </div>
                </div>
            </div>

            <input id="urlEditData" type="hidden" value="<?= Url::toRoute(['contenido/editar']); ?>">
            ...
            <table id="list-datos" class="display" cellspacing="0" width="90%">
                <thead>
                    <tr>
                        ...
                        <th><?php echo Yii::t("app", "TITULO"); ?></th>
                ...
                <div class="modal-dialog" role="document" style="margin: 10px 5%; width: 90%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title"><?php echo Yii::t("app", "CREAR_ARTICULO"); ?></h4>
                        </div>
                            ...
                            <form id="formulario">
                                ...
                                <div class="form-group">
                                    <div class="row gutter">
                                        ...
                                        <div class="col-md-12">
                                            <label class="control-label"><?= Yii::t('app', "TITULO") ?></label>
                                            <input type="text" id="art_titulo" name="art_titulo" class="form-control"> 
                                        </div>
                                        
                                        <div class="col-md-12">
                                            <label class="control-label"><?= Yii::t('app', "DESCRIPCION") ?></label>
                                            <input type="text" id="art_desc" name="art_desc" class="form-control"> 
                                        </div>
                                        
                                        <div class="col-md-12">
                                            <label class="control-label"><?= Yii::t('app', "RESENA") ?></label>
                                            <input type="text" id="art_resena" name="art_resena" class="form-control"> 
                                        </div>
                                        
                                        <div class="col-md-12">
                                            <label class="control-label"><?= Yii::t('app', "FOTO") ?></label>
                                            <input type="file" id="art_foto_ruta" name="art_foto_ruta" class="form-control"> 
                                        </div>
                                        
                                        <div class="col-md-12">
                                                <label class="control-label"><?= Yii::t('app', "CONTENIDO") ?></label>
                                                <textarea name="editor1" id="editor1" rows="10" cols="80">
                                                    
                                                </textarea>
                                                <input type="hidden" id="art_contenido" name="art_contenido" class="form-control"> 
                                                <script>
...
<script type="text/javascript">
    ...
    var CAMPO_VACIO = '<?php echo Yii::t("app", "CAMPO_VACIO") ?>'; 
    var LONG_MAX = '<?php echo Yii::t("app", "LONG_MAX") ?>'; 
    ...
    $(document).ready(function () {
        ...
        var table = $('#list-datos').DataTable({
            ...
            "ajax": "<?php echo Url::toRoute(['contenido/dataarticulos']); ?>",
            "language": {
...
<script src="../views/contenido/js/articulos.js"></script>
