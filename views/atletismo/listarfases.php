...
<body class="background_images">
            ...
            <nav class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active">
                            <?php
                                echo Html::a('<i class="icon-graphic_eq"></i>' . Yii::t("app", "CAMPEONATO"), ["atletismo/listar", 'idDeporte' => $campeonato->dep_id]);
                            ?>
                        </li>
                        <li class="active">
    ...
    <!-- MODAL NUEVA FASE -->
    <div class="modal fade" id="modalForm1" role="dialog" aria-labelledby="modalForm3">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <h4 class="modal-title"><?php echo Yii::t("app", "CREAR_FASE_CAMPEONATO"); ?></h4>
                    <strong><?= Yii::t('app', "TOTAL_EQUIPOS_PROMOCIONADOS").": 0" ?></strong>
                </div>
                <div class="modal-body">
                    <form id="formulario-fase" onsubmit="return false;">
                        <div class="row gutter">
                            <div class="col-md-12">
                                <div class="col-md-6 col-xs-12">
                                    <label class="control-label"><?php echo Yii::t('app',"TIPO_FASE")?></label>
                                    <select class="form-control">
                                        <option value=""><?php echo Yii::t('app',"SELECCIONE") ?></option>
                                        <option value="1"><?php echo Yii::t('app',"CLASIFICATORIA") ?></option>
                                        <option value="2"><?php echo Yii::t('app',"SEMIFINAL") ?></option>
                                        <option value="2"><?php echo Yii::t('app',"FINAL") ?></option>
                                    </select>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <label class="control-label"><?php echo Yii::t('app',"CATEGORIA")?></label>
                                    <input type="text" class="form-control" name="" value="Juvenil" readonly>
                                </div>
                            </div>   
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6 col-xs-12">
                                    ...
                                    <input id="" type="text" class="form-control" name="" value="Masculino" readonly>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <label class="control-label"><?php echo Yii::t('app',"PRUEBA") ?></label>
                                    <input id="" type="text" class="form-control" name="" value="100 MTS PLANOS" readonly>
                                </div>
                            </div> 

                            <div class="col-md-12">
                                <div class="col-md-6 col-xs-12">
                                    <button class="btn btn-default">Participantes</button>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <label class="control-label"><?php echo Yii::t('app',"CANTIDAD_SERIES")?>:</label>
                                    <input style="width: 40px;float: right;" type="number" name="" min="1">
                                </div>
                            </div>

                            <div class="col-md-12">
                                <div class="col-md-6 col-xs-12">
                                    <label class="control-label"><?php echo Yii::t('app',"CANTIDAD_CLASIFICADOS")?>:</label>
                                    <input style="width: 40px;float: right;" type="number" name="" min="1">
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        <label class="control-label"><?php echo Yii::t('app',"CANTIDAD_RECLASIFICADOS_MARCA")?>:</label>
                                        <input style="width: 40px;float: right;" type="number" name="" min="1">
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#list-datos').DataTable({
            ...
            "ajax": "<?php echo Url::toRoute(['atletismo/datafases',  'camp_id' => $campeonato->camp_id]); ?>",
