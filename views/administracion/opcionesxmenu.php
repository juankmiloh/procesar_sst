...
<body class="background_images">
            ...
            <nav class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active">
                            <a><i class="icon-graphic_eq"></i> <?= Yii::t("app", "MENU_X_ENLACE") ?></a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <div class="container-fluid">
                <div class="row gutter">
                    <div class="col-md-10 col-sm-6 col-xs-12">
                        <h3 class="page-title"><?= Yii::t('app', "MENU_X_ENLACE") ?></h3>
                    </div>
            ...
            <table id="list-registros" class="display" cellspacing="0" width="90%">
                <thead>
                    <tr>
                        ...
                        <th><?php echo Yii::t("app", "ENLACE"); ?></th>
                        <th></th>
                    </tr>
                </thead>
                <tfoot>
    ...
    <input id="urlCrear" type="hidden" value="<?= Url::toRoute(['administracion/crearopcionesxmenu']); ?>">
    <input id="urlEditar" type="hidden" value="<?= Url::toRoute(['administracion/datosopcionesxmenu']); ?>">
                                        ...
                                        <div class="form-group">
                                                <div class="row gutter">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row gutter">
                                                                ...
                                                                <label class="control-label"><?= Yii::t('app', "MENU") ?></label>
                                                                <?php
                                                                    $items = ArrayHelper::map(\app\models\Menu::find()->all(), 'menu_id', 'menu_nombre');
                                                                    echo Html::dropDownList('menu', 'menu', $items, ['prompt' => Yii::t('app', "SELECCIONE"), 'class' => 'form-control', 'id' => 'menu', 'name' => 'menu']);
                                                                ?>
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="row gutter">
                                                                ...
                                                                <?php
                                                                    echo Html::a(Yii::t("app", "CREAR_MENU"), array("administracion/menu"), array("class"=>"btn btn-info"));
                                                                ?>
                                                ...
                                                <div class="row gutter">
                                                        ...
                                                        <div class="row style-select">
                                                                <div class="col-xs-5">
                                                                        <label class="control-label"><?=Yii::t('app', "ENLACES")?></label>
                                                                        <?php
                                                                            $items = ArrayHelper::map(\app\models\Enlace::find()->all(), 'enl_id', 'enl_nombre');
                                                                  ...
                                                                  <div class="col-xs-5">
                                                                        <label class="control-label"><?=Yii::t('app', "ENLACES_ASIGNADOS")?></label>
                                                                        <select name="enlaces[]" id="multiselect_to" class="form-control" size="8" multiple="multiple"></select>
                                                                  </div>
                                                        </div>
                                                    </div>
                                        </div>
...
<script>
    ...
    var MENU_NECESARIO_ENLACE = '<?php echo Yii::t("app", "MENU_NECESARIO_ENLACE") ?>';
    var ENLACE_NECESARIO = '<?php echo Yii::t("app", "ENLACE_NECESARIO") ?>';
    ...
    $(document).ready(function () {
        ...
        $('#list-registros').DataTable({
            ...
            "serverSide": true,
            "order": [[ 0, "desc" ]],
            "ajax": "<?php echo Url::toRoute(['administracion/getopcionesxmenu']); ?>",
            "language": {
...
<script src="../views/administracion/js/opcionesxmenu.js"></script>