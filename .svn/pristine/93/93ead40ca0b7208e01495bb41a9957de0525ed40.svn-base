            ...
            <nav class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active">
                            <a><i class="icon-graphic_eq"></i> <?= Yii::t("app", "BITACORA") ?></a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        $('#list-datos thead tr:eq(1) th').each( function () {
            ...
            if(column > 0 && column < ($('#list-datos').columnCount() - 1)){ 
                ...
                if(column == 2){//Construye una lista 
                    <?php
                        $html = Html::dropDownList('usu_id', 'usu_id', $usuarios, ['prompt' => Yii::t('app', ''), 'class' => 'form-control filter', 'id' => 'usu_id', 'name' => 'usu_id']);
                        $html = preg_replace( "/\r|\n/", "", $html );;
                        $data = "";
                    ?>
