...
<body class="background_images">
            ...
            <nav class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active">
                            <a><i class="icon-graphic_eq"></i> <?= Yii::t("app", "ROLES") ?></a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <div class="container-fluid">
                <div class="row gutter">
                    <div class="col-md-10 col-sm-6 col-xs-12">
                        <h3 class="page-title"><?= Yii::t('app', "ROLES") ?></h3>
                    </div>
                    <div class="col-md-2 col-sm-6 col-xs-12">
                        <ul class="tasks pull-right clearfix">
                            <button type="button" class="btn teal-bg btn-block" onclick="cleanForm()" data-toggle="modal" data-target="#modal-registro"><i class="icon-circle-plus icon-left"></i><?= Yii::t('app', "CREAR_ROL") ?></button>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <input id="urlCrear" type="hidden" value="<?= Url::toRoute(['administracion/crearrol']); ?>">
    <input id="urlEditar" type="hidden" value="<?= Url::toRoute(['administracion/datosrol']); ?>">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><?=Yii::t('app', "CREAR_ROL")?></h4>
                </div>
                                        ...
                                        <div class="form-group">
                                                <div class="row gutter">
                                                        <div class="col-md-6">
                                                                ...
                                                                <input type="url" id="nombre_rol" class="form-control" name="nombre_rol" onkeypress="soloLetras(event);">
                                                        ...
                                                        <div class="col-md-12">
                                                                ...
                                                                <textarea class="form-control" id="detalle_rol" name="detalle_rol"></textarea>
...
<script>
    ...
    var MAX_LENGHT_ROL_NOMBRE = '<?php echo Yii::t("app", "MAX_LENGHT_ROL_NOMBRE") ?>';
    var MIN_LENGHT_ROL_NOMBRE = '<?php echo Yii::t("app", "MIN_LENGHT_ROL_NOMBRE") ?>';
    var ROL_EXITO = '<?php echo Yii::t("app", "ROL_EXITO") ?>'; 
    var ROL_EXITO_EDICION = '<?php echo Yii::t("app", "ROL_EXITO_EDICION") ?>';
    ...
    $(document).ready(function () {
        ...
        $('#list-registros').DataTable({
            ...
            "serverSide": true,
            "order": [[ 0, "desc" ]],
            "ajax": "<?php echo Url::toRoute(['administracion/getroles']); ?>",
            "language": {
...
<script src="../views/administracion/js/roles.js"></script>