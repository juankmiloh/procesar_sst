...
?>  
 <div class="kode-subheader subheader-height">
            ...
            if(evento == "" || evento == undefined){
                ...
                $.ajax({
                        ...
                        success: function (response) {
                            ...
                            /**
                             * Agregamos la clase a los dias que tiene fechas...
                             */
                            for(var j = 0; j < fechas.length; j++){
                                var fecha = fechas[j]['tfs_fecha_hora'].split(" ");
                                var item = $("ul").find("[data-moment='"+fecha[0]+"']");
                                if(item != undefined && item != ""){
                                    item.addClass("dp-item dp-selected-green");
                                }
                            }
                            ...
                            for(var i = 0; i < obj.length; i++){
                                ...
                                temp += '    </li>';
                                temp += '    <li>';								
                                temp += '      <div>'+obj[i]['dp1']+'</div>';
                                temp += '      <span>/</span>';
                                temp += '      <div>'+obj[i]['dp2']+'</div>';								
								temp += '    </li>';
    ...
    <style>
        .dp-selected-green {
            background-color: #00dd1c!important;
            color: #fff!important;
            width: 140px;
        }
    </style>